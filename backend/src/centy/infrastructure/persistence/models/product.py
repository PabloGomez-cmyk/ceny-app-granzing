...
class ProductModel(Base):
    ...
    roll_width_cm: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False, server_default="152")
    roll_length_m: Mapped[float] = mapped_column(Numeric(8, 2), nullable=False, server_default="30")
    # WINDOW, AUTOMOTIVE — max 2 elementos
    application_types: Mapped[list[str]] = mapped_column(ARRAY(String(20)), nullable=False)
